...
('STORY_LIKED', 3, 2, 4, 'UNREAD', now(), now()),  -- cos(3)이 ssar(2)의 스토리(id=1)를 좋아요 → story_like.id = 4
('STORY_LIKED', 8, 2, 19, 'READ', now(), now()),   -- luna(8)이 ssar(2)의 스토리(id=1)를 좋아요 → story_like.id = 19
('STORY_LIKED', 5, 9, 11, 'UNREAD', now(), now()), -- mango(5)이 zero(9)의 스토리(id=8)를 좋아요 → story_like.id = 11
('STORY_LIKED', 9, 7, 23, 'UNREAD', now(), now()), -- zero(9)이 neo(7)의 스토리(id=6)를 좋아요 → story_like.id = 23
('STORY_LIKED', 3, 6, 5, 'READ', now(), now()); -- cos(3)이 hana(6)의 스토리(id=5)를 좋아요 → story_like.id = 5